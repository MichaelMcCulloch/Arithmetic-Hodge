...
def BombieriLiSpectralApproximationScratch
...
theorem bombieriOffCriticalSpectralNegativity_of_liApproximationScratch
    (zeros : ZetaZeroEnumeration)
    (happrox : BombieriLiSpectralApproximationScratch zeros) :
