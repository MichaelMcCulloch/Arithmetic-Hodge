...
// Module: ArithmeticHodge.Spectral.ResolventComputation
// Imports: public import Init public import Mathlib.Analysis.InnerProductSpace.Basic public import Mathlib.Analysis.InnerProductSpace.Adjoint public import Mathlib.Analysis.InnerProductSpace.l2Space public import Mathlib.Topology.Algebra.InfiniteSum.Basic public import ArithmeticHodge.Spectral.SpectralPositivity public import ArithmeticHodge.Adelic.SelbergUnfolding
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Analysis_InnerProductSpace_l2Space(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_ArithmeticHodge_ArithmeticHodge_Spectral_ResolventComputation(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Analysis_InnerProductSpace_l2Space(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
