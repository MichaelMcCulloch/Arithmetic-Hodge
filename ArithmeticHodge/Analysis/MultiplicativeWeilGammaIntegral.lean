/-
  The integrated real-part digamma series in Bombieri's Weil functional.

  The pointwise digamma expansion has already been shown absolutely
  integrable term by term.  This module combines its initial Cauchy kernel,
  Euler-constant term, and infinite harmonic-subtracted series into the exact
  integrated identity used on the way to Bombieri's equation (2.8).
-/
...
/-- The real part of `ψ(1/4 + iv/2)` times the critical-line Mellin
transform is genuinely Bochner integrable.  This validates splitting its
integral into the three terms used immediately before Bombieri (2.8). -/
...
/-- The exact normalized integral of the real-part digamma series against a
Bombieri Mellin transform.  This packages the integrated gamma-factor step
whose weighted Cauchy terms feed directly into Bombieri's equation (2.8). -/
