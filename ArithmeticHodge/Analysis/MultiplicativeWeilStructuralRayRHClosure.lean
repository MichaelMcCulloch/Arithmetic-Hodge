...
positive ray of the actual common-parent residual pencil.
-/
...
/-- The complete sharpened analytic frontier, with no finite-window or
singular-pivot bookkeeping left implicit. -/
