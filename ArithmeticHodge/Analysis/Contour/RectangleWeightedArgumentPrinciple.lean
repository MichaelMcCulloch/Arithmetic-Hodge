...
/-!
# Weighted argument principle on rectangles

The rectangular contour integral of `H · F'/F` is the finite sum of the
divisor orders of `F`, weighted by the holomorphic values `H(ρ)`.
-/
...
/-- The weighted rectangular argument principle for a finite divisor strictly
inside a closed axis-parallel rectangle. -/
theorem rectIntegral_weighted_logDeriv
