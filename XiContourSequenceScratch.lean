...
/-- Every entire weight admits an exhaustion by paired zero-free xi rectangles
on which the weighted argument principle is an exact finite multiplicity sum. -/
theorem exists_xi_contour_sequence_scratch
...
#print axioms ArithmeticHodge.Analysis.exists_xi_contour_sequence_scratch
