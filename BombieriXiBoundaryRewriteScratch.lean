...
/-- Away from a discrete exceptional set, `xi'/xi` is the sum of the zeta
logarithmic derivative, its two polar corrections, and the real-gamma
correction.  Hence the corresponding weighted raw rectangle integrals agree
without requiring the rectangle interior to be zero-free. -/
theorem rectIntegral_weighted_xi_logDeriv_eq_zeta_gamma_polar_scratch
    (H : ℂ → ℂ) (z w : ℂ) :
...
#print axioms
  ArithmeticHodge.Analysis.rectIntegral_weighted_xi_logDeriv_eq_zeta_gamma_polar_scratch
